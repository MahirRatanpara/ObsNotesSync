...
**This is why circuit breakers should trip on slow calls, not just errors.** See [Circuit Breaker](Circuit%20Breaker.md).
...
**Never order distributed events by wall-clock timestamps.** See [Clocks and Ordering](Clocks%20and%20Ordering.md).
...
- [Failure Detection and Recovery](Failure%20Detection%20and%20Recovery.md)
