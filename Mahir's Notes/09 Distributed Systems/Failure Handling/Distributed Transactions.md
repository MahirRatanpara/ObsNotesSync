...
Covered fully in [Multi-Step Processes and Saga](Multi%20Step%20Processes%20and%20Saga.md).
...
**Solution: the [transactional outbox](Transactional%20Outbox.md)** — write the event into the same database in the same transaction, and publish asynchronously.
...
**This is how real payment systems handle the [Two Generals Problem](Two%20Generals%20Problem.md) in production.** The protocol reduces divergence; reconciliation catches what remains. Volunteering it is a strong signal.
...
- [Transactional Outbox](Transactional%20Outbox.md)
