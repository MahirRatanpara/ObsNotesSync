...
| Note | What it covers |
|---|---|
| [JPA and Hibernate](JPA%20and%20Hibernate.md) | The ORM layer is where most Spring performance problems originate. Interviewers ask about N+1 because it separ… |
...
| [Spring Web and Boot Internals](Spring%20Web%20and%20Boot%20Internals.md) | Explains how a request actually flows, what auto-configuration is doing, and the MVC-versus-WebFlux decision t… |
