...
**Optimistic locking throws `OptimisticLockException` on conflict** — the caller must catch and retry. Prefer it; use pessimistic only under genuine high contention. See [Transactions and Isolation Levels](Transactions%20and%20Isolation%20Levels.md).
