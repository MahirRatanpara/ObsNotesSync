...
|---|---|
| Only one instance should exist | [Singleton](Singleton.md) |
| Create objects without naming the class | [Factory Method](Factory%20Method.md) |
| Families of related objects that must match | [Abstract Factory](Abstract%20Factory.md) |
| Too many constructor parameters | [Builder](Builder.md) |
| Copying beats constructing | [Prototype](Prototype.md) |
| Incompatible interfaces must work together | [Adapter](Adapter.md) |
| Add behaviour at runtime, stackable | [Decorator](Decorator.md) |
| Control access to an object | [Proxy](Proxy.md) |
| Simplify a complex subsystem | [Facade](Facade.md) |
| Treat leaf and tree uniformly | [Composite](Composite.md) |
| Two independent axes of variation | [Bridge](Bridge.md) |
| Millions of objects, memory pressure | [Flyweight](Flyweight.md) |
| Swap the algorithm at runtime | [Strategy](Strategy.md) |
| Notify many on a change | [Observer](Observer.md) |
| Behaviour depends on lifecycle stage | [State](State.md) |
| Undo, queue, or log requests | [Command](Command.md) |
| Pipeline of handlers, may short-circuit | [Chain of Responsibility](Chain%20of%20Responsibility.md) |
| Fixed skeleton, varying steps | [Template Method](Template%20Method.md) |
| Traverse without exposing internals | [Iterator](Iterator.md) |
| Many-to-many component tangle | [Mediator](Mediator.md) |
| Snapshot and restore state | [Memento](Memento.md) |
| Add operations to a stable hierarchy | [Visitor](Visitor.md) |
| Evaluate a small grammar | [Interpreter](Interpreter.md) |
