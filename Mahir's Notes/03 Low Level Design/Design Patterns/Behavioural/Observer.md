...
Decouples latency, but you lose ordering guarantees and error visibility. At service boundaries this becomes a message broker — Observer scaled out is pub-sub ([Kafka](Kafka%20Deep%20Dive.md) consumer groups are the distributed form).
