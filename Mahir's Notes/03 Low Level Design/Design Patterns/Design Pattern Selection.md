...
If you must implement it, use the **Bill Pugh holder idiom** (see [Java Memory Model](Java%20Memory%20Model.md)) or an `enum`, which is serialisation- and reflection-safe.
