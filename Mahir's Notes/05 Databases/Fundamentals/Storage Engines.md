...
**The WAL is what makes commits fast** — a sequential append and fsync, rather than waiting for random page writes. Recovery replays the log. See [Database Replication](Database%20Replication.md).
...
**Bloom filters are what make LSM reads viable.** Without them, every read would touch every SSTable. See [Data Structures for Big Data](Data%20Structures%20for%20Big%20Data.md).
...
- [Time Series and Analytics Databases](Time%20Series%20and%20Analytics%20Databases.md)
