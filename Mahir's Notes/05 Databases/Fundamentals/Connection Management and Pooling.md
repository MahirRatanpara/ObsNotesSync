...
**Read-after-write breaks** — a user writes to the primary and immediately reads a lagging replica. Route that user's reads to the primary for a few seconds after any write. See [Consistency Models](Consistency%20Models.md).
...
- [Locking and Concurrency Control](Locking%20and%20Concurrency%20Control.md)
