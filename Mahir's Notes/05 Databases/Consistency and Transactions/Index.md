...
| Note | What it covers |
|---|---|
| [Locking and Concurrency Control](Locking%20and%20Concurrency%20Control.md) | How databases let many transactions run at once without corrupting each other — and how to choose between bloc… |
