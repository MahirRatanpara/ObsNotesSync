...
| Listeners never unregistered | The [Observer](Observer.md) leak |
...
**Escape analysis may eliminate the allocation entirely** for non-escaping objects — so don't hand-optimise before checking whether the JIT already did. See [JIT and Escape Analysis](JIT%20and%20Escape%20Analysis.md).
