...
**Increasing partitions later breaks key-to-partition mapping**, so over-provision partitions rather than under-provision. See [Kafka Deep Dive](Kafka%20Deep%20Dive.md).
...
- **At-least-once delivery** → consumers must be [idempotent](Idempotent%20Consumers.md)
...
- [Retries and Dead Letter Queues](Retries%20and%20Dead%20Letter%20Queues.md)
