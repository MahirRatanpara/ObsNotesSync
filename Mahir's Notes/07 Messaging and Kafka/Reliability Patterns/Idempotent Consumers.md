...
This is the [Two Generals Problem](Two%20Generals%20Problem.md): the broker cannot distinguish "consumer died before processing" from "consumer processed but died before acknowledging". It must redeliver, so you must tolerate it.
