...
**Deleting millions of rows generates dead tuples and vacuum load in Postgres.** Partitioning by day and dropping partitions is far cheaper. See [PostgreSQL](PostgreSQL.md).
