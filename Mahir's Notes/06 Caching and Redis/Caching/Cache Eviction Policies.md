...
**Implementation:** hash map + doubly linked list gives O(1) get and evict. See [LRU Cache](LRU%20Cache.md).
...
**Frequency is estimated with a [Count-Min Sketch](Data%20Structures%20for%20Big%20Data.md)** — approximate counts for a huge key space in a few kilobytes, with periodic ageing.
