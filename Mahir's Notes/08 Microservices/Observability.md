...
Averaging per-host p99s is mathematically meaningless. For a fleet-wide p99 you must merge **histograms** or **t-digest sketches**. See [Data Structures for Big Data](Data%20Structures%20for%20Big%20Data.md).
