...
**This is exactly what [ZooKeeper ephemeral nodes](ZooKeeper%20and%20Coordination.md) provide** — the registration disappears automatically when the session dies.
...
**DNS alone is insufficient for fast failover.** Use it for coarse routing (region selection) and a health-checked load balancer or mesh for instance selection. Same conclusion as in [Networking Essentials](Networking%20Essentials.md).
...
- [ZooKeeper and Coordination](ZooKeeper%20and%20Coordination.md)
