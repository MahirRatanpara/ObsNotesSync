...
A **timeout tells you nothing** about whether the operation succeeded — see [Two Generals Problem](../../09%20Distributed%20Systems/Theory/Two%20Generals%20Problem.md). This is exactly why idempotency and retry are inseparable topics.
