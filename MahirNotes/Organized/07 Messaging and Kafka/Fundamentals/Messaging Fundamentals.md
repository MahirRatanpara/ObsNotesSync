...
**Exactly-once never crosses the broker boundary.** Kafka's exactly-once covers Kafka-to-Kafka only. The moment your consumer writes to a database or calls an external API, you need [idempotency](../Reliability%20Patterns/Idempotent%20Consumers.md).
