...
Data is partitioned by **consistent hashing** onto a ring, with virtual nodes for even distribution. See [Consistent Hashing](../Core%20Concepts/Consistent%20Hashing.md).
...
- [Consistent Hashing](../Core%20Concepts/Consistent%20Hashing.md)
- [CAP and PACELC](../Core%20Concepts/CAP%20and%20PACELC.md)
