...
**Required on any non-idempotent operation with money or side effects.** A network timeout is ambiguous — the client cannot know whether the payment succeeded, so it must be safe to retry. See [Two Generals Problem](../../09%20Distributed%20Systems/Theory/Two%20Generals%20Problem.md).
...
- [HTTP and TLS](../../11%20Networking/Protocols/HTTP%20and%20TLS.md)
- [API Gateway](../../08%20Microservices/API%20Gateway.md)
- [Rate Limiting](../Patterns/Rate%20Limiting.md)
