...
**Reconciliation job** for the ambiguous case: payment succeeded but the webhook never arrived. Poll the provider for holds that expired with a pending payment. This is the [Two Generals Problem](../../09%20Distributed%20Systems/Theory/Two%20Generals%20Problem.md) in production.
...
- [Scaling Writes](../Patterns/Scaling%20Writes.md)
