...
- **Async I/O**, not thread-per-request. 1,000 concurrent fetches on threads would need 1 GB of stack; an event loop handles it in one process. See [Processes and Threads](../../10%20Operating%20Systems/Processes%20and%20Threads/Processes%20and%20Threads.md).
...
- [Elasticsearch](../Key%20Technologies/Elasticsearch.md)
- [Messaging Fundamentals](../../07%20Messaging%20and%20Kafka/Fundamentals/Messaging%20Fundamentals.md)
