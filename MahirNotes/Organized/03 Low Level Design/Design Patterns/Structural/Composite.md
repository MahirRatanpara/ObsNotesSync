...
Composite defines the structure; [Visitor](../Behavioural/Visitor.md) adds operations over it without modifying the node classes. Compilers use exactly this pair: Composite for the AST, Visitor for type-checking, optimisation, and code generation.
