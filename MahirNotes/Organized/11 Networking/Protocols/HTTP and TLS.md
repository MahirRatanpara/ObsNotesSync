...
**PUT is idempotent, POST is not** — that's why retrying a POST can double-charge a customer, and why write endpoints need an idempotency key. See [Idempotent Consumers](../../07%20Messaging%20and%20Kafka/Reliability%20Patterns/Idempotent%20Consumers.md).
...
**mTLS** adds client certificate verification in the other direction — the basis of zero-trust service-to-service authentication and what a [service mesh](../../08%20Microservices/Service%20Mesh.md) automates.
...
- [Networking Essentials](../Fundamentals/Networking%20Essentials.md)
