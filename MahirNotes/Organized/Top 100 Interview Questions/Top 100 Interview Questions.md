...
→ [Java Memory Model](../02%20Java/JVM%20and%20Memory/Java%20Memory%20Model.md) · [Synchronisation and Locks](../02%20Java/Concurrency/Synchronisation%20and%20Locks.md) · [Executors](../02%20Java/Concurrency/Executors%20and%20Thread%20Pools.md)
...
→ [HashMap Internals](../02%20Java/Collections/HashMap%20Internals.md) · [Garbage Collection](../02%20Java/Garbage%20Collection/Garbage%20Collection.md) · [JIT and Escape Analysis](../02%20Java/JVM%20and%20Memory/JIT%20and%20Escape%20Analysis.md)
...
→ [Pattern Recognition Framework](../01%20DSA/Foundations/Pattern%20Recognition%20Framework.md) · [Pattern Confusion Matrix](../01%20DSA/Foundations/Pattern%20Confusion%20Matrix.md) · [LRU Cache](../01%20DSA/Arrays%20and%20Strings/LRU%20Cache.md)
...
→ [CAP and PACELC](../04%20High%20Level%20Design/Core%20Concepts/CAP%20and%20PACELC.md) · [Consensus Algorithms](../09%20Distributed%20Systems/Consensus/Consensus%20Algorithms.md) · [Two Generals Problem](../09%20Distributed%20Systems/Theory/Two%20Generals%20Problem.md)
...
→ [Caching](../04%20High%20Level%20Design/Core%20Concepts/Caching.md) · [Database Indexing](../05%20Databases/Indexing/Database%20Indexing.md) · [Kafka Deep Dive](../07%20Messaging%20and%20Kafka/Kafka/Kafka%20Deep%20Dive.md) · [Circuit Breaker](../08%20Microservices/Circuit%20Breaker.md)
...
→ [Design Pattern Selection](../03%20Low%20Level%20Design/Design%20Patterns/Design%20Pattern%20Selection.md) · [Design Patterns Cheat Sheet](../Cheat%20Sheets/Design%20Patterns%20Cheat%20Sheet.md) · [SOLID Principles](../03%20Low%20Level%20Design/SOLID/SOLID%20Principles.md)
