...
**Adding a new `Shape` breaks compilation everywhere it's switched on** — which is exactly what you want. This is the modern alternative to the [Visitor pattern](../../03%20Low%20Level%20Design/Design%20Patterns/Behavioural/Visitor.md), with compile-time safety and none of the double-dispatch ceremony.
...
**This is what makes thread-per-request viable again** and removes most of the reason to adopt reactive frameworks. See [Spring Web and Boot Internals](../../14%20Spring%20Boot/Spring%20Web%20and%20Boot%20Internals.md).
