...
Rough numbers, aggressively rounded. See [Back of the Envelope Estimation](../../04%20High%20Level%20Design/Interview%20Framework/Back%20of%20the%20Envelope%20Estimation.md).
...
2. **Derive via CDC**, not dual writes — dual writes drift. See [Transactional Outbox](../../07%20Messaging%20and%20Kafka/Reliability%20Patterns/Transactional%20Outbox.md).
...
- [Database Comparison Reference](../Specific%20Databases/Database%20Comparison%20Reference.md)
