...
> Lookup table. Use alongside [Choosing the Right Database](../Fundamentals/Choosing%20the%20Right%20Database.md), which has the decision procedure.
...
**The Postgres/MySQL default difference matters:** code correct on one can be subtly wrong on the other. See [Transactions and Isolation Levels](../Consistency%20and%20Transactions/Transactions%20and%20Isolation%20Levels.md).
...
- [Choosing the Right Database](../Fundamentals/Choosing%20the%20Right%20Database.md)
- [Storage Engines](../Fundamentals/Storage%20Engines.md)
- [SQL vs NoSQL](../SQL%20vs%20NoSQL/SQL%20vs%20NoSQL.md)
- [PostgreSQL](../../04%20High%20Level%20Design/Key%20Technologies/PostgreSQL.md) · [Cassandra](../../04%20High%20Level%20Design/Key%20Technologies/Cassandra.md) · [DynamoDB](../../04%20High%20Level%20Design/Key%20Technologies/DynamoDB.md)
