...
- [x] **14.** [Shortest Palindrome](https://leetcode.com/problems/shortest-palindrome) 🔴 Hard
	- [x] Importance of LPS in KMP, VIMP
...
- [x] **131.** [Max Value of Equation](https://leetcode.com/problems/max-value-of-equation) 🔴 Hard
...
- [x] **228.** [Repeated String Match](https://leetcode.com/problems/repeated-string-match) 🟡 Medium - Rabin Karp Pending
...
- [x] **279.** [IPO](https://leetcode.com/problems/ipo) 🔴 Hard
- [x] **280.** [Maximum Difference Between Node and Ancestor](https://leetcode.com/problems/maximum-difference-between-node-and-ancestor) 🟡 Medium
...
- [x] **285.** [Maximum Gap](https://leetcode.com/problems/maximum-gap) 🟡 Medium
...
1. Click on any problem name to open it on LeetCode
2. After solving, check the box: `- [x]` to mark as complete
3. Track your progress with the statistics below
...
- Try to identify the pattern yourself before looking at hints
- Focus on understanding the approach, not just solving
- Revisit problems after a few weeks to reinforce learning
