...
- Desgin Pattern Notes
- AlgoMaster LLD List: https://github.com/ashishps1/awesome-low-level-design/tree/main
- https://codewitharyan.com/system-design/low-level-design

HLD:

- Personal Detailed Notes
- Alex Xu's Both books
- HelloInterview

Java & Spring:

- I have a PDF which if of 500 pages which I can refer, else I have some personal notes as well

AI:
- For now I am following anthropic skill jar course and 3b1b videos on LLM
- I also want to create 1-2 sample project which can cover making agents